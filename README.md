...
shader_glsl = open("/mnt/data/pulse_perlin_overlay/src/shader.glsl","r").read() if os.path.exists("/mnt/data/pulse_perlin_overlay/src/shader.glsl") else ""

main_cpp = textwrap.dedent(r"""
#include <cmath>
#include <cstdint>
#include <cstdio>
#include <cstdlib>
...
files = {
    ...
    "src/shader.glsl": shader_glsl or "// shader placeholder\n",
}
